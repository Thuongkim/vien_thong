...
var Agency = function(){
	...
	var dzTheme = function(){
		 ...
		 if(screenWidth < 991)
		{
			...
			jQuery('.mo-left .header-nav .logo-header > a > img').attr('src','images/logo-black.html');
			jQuery('.mo-left.lw .header-nav .logo-header > a > img').attr('src','images/logo-white.html');
		}
	}
