...
class NewsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image'))
            $validator = Validator::make($data = $request->only('category', 'title', 'image', 'content', 'summary', 'status', 'featured'), News::rules());
        else
            $validator = Validator::make($data = $request->only('category', 'title', 'content', 'summary', 'status', 'featured'), News::rules());
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('image'))
            $validator = Validator::make($data = $request->only('category', 'title', 'image', 'content', 'summary', 'status', 'featured'), News::rules($id));
        else
            $validator = Validator::make($data = $request->only('category', 'title', 'content', 'summary', 'status', 'featured'), News::rules($id));
