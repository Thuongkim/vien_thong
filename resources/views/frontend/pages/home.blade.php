								...
								<ul>
									...
									<li data-index="rs-100" data-transition="slideoververtical"
										...
										<a class="tp-caption rev-btn tc-btnshadow tp-rs-menulink" href="{!! route('home.static-page', 'thong-tin-chung') !!}"
											...
											style="z-index: 8;letter-spacing: 2px; white-space: nowrap; font-size: 12px; font-weight: 600; color: rgba(255,255,255,1); font-family:rubik; background-color:#00577d; text-transform: uppercase; border-radius: 30px">
