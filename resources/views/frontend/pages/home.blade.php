								...
								<ul>
									...
									<li data-index="rs-100" data-transition="slideoververtical"
										...
										<a class="tp-caption rev-btn tc-btnshadow tp-rs-menulink" href="{!! route('home.static-page', 'thong-tin-chung') !!}"
											...
											style="z-index: 8;letter-spacing: 2px; white-space: nowrap; font-size: 12px; font-weight: 600; color: rgba(255,255,255,1); font-family:rubik; background-color:#3c7ba4; text-transform: uppercase;">
							...
							<div id="sync1"
								...
								<div class="item">
									<div class="row service align-items-center">
										...
										<div class="col-lg-6 col-md-6 m-b30">
											<img src="{{ asset($servicesLang['image']) }}" class="radius-sm" style="max-height: 320px;max-width: 540px;padding: 0px;">
										</div>
									</div>
								</div>
								@endforeach
