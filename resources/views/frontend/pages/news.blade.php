		...
		<div class="dlab-bnr-inr overlay-black-middle bg-pt active wow zoomIn" style="background-image:url({{ asset('assets/frontend/images/main-slider/abc.png') }});">
			<div class="container">
				<div class="dlab-bnr-inr-entry">
					<h1 class="text-white" style="text-transform: uppercase;">{{trans('frontend.news_event')}}</h1>
					<!-- Breadcrumb row -->
					...
					@endphp">
                        ...
                        <div class="dlab-post-info">
							...
							<div class="dlab-post-title">
                                <h4 class="post-title"><a href="{{ route('news.show', ['slug' => str_slug($news_st[$lang]['title']), 'id' => $news_st['id']]) }}">{!! \App\Helper\HString::modSubstr($news_st[$lang]['title'], 95) !!}</a></h4>
                            </div>
