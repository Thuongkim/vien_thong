                ...
                {!! Form::open(['role' => 'form']) !!}
                    <table class='table borderless' style="width: 60%;">
                        <tr>
                            ...
                            <td>
                                {!! Form::input('password', 'current_password', '', array('class' => 'form-control', 'maxlength' => 30)) !!}
                            </td>
                        </tr>
                        <tr>
                            <th class="text-right">
                            ...
                            <td>
                                {!! Form::input('password', 'new_password', '', array('class' => 'form-control', 'maxlength' => 30)) !!}
                            </td>
                        </tr>
                        <tr>
                            <th class="text-right">
                            ...
                            <td>
                                {!! Form::input('password', 're_password', '', array('class' => 'form-control', 'maxlength' => 30)) !!}
                            </td>
                        </tr>
                        <tr>
