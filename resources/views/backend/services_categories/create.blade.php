...
@section('title')
    {!! trans('system.action.create') !!} - {!! trans('service_categories.label_categories') !!}
@stop
...
@section('content')
    ...
    @endif
    {!! Form::open(array('url' => route('admin.service-categories.store'), 'role' => 'form')) !!}
        ...
        <table class='table borderless' style="width: 80%;">
            ...
            <tr>
                ...
                <td>
                    {!! Form::select('parent', ['' => trans('services.categories.parent_category')] + $categories, old('parent'), ["class" => "form-control"]) !!}
                </td>
            </tr>
            <tr>
                <th class="table_right_middle">
